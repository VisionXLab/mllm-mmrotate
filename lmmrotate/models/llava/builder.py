...
from .language_model import (
    ...
    LlavaMixtralForCausalLM, LlavaQwenMoeForCausalLM, LlavaGemmaForCausalLM,
)
from .constants import DEFAULT_IMAGE_PATCH_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN
from lmmrotate.utils import rank0_print


def load_pretrained_model(model_path, model_base=None, model_name="", load_8bit=False, load_4bit=False, device_map="auto", torch_dtype="float16",attn_implementation="flash_attention_2", customized_config=None, overwrite_config=None, **kwargs):
