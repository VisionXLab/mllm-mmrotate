...
class Florence2LearnedPositionalEmbedding(nn.Embedding):
    ...
    def __init__(self, num_embeddings: int, embedding_dim: int, *args, **kwargs):
        ...
        super().__init__(num_embeddings + self.offset, embedding_dim, *args, **kwargs)
    ...
    def from_pretrained(cls, embeddings, freeze=True, **kwargs):
        ...
        return cls(
            num_embeddings=rows - cls.offset,
            embedding_dim=cols,
            _weight=embeddings,
            _freeze=freeze,
            **kwargs)
...
class Florence2ForConditionalGeneration(Florence2PreTrainedModel):
    ...
    def get_encoder(self):
        return self.get_language_model().get_encoder()

    def get_decoder(self):
        return self.get_language_model().get_decoder()

    def get_input_embeddings(self):
        return self.get_language_model().get_input_embeddings()
    
    def get_output_embeddings(self):
        return self.get_language_model().get_output_embeddings()
    
    def get_vision_tower(self):
        return self.vision_tower
    
    def get_mm_projection(self):
